...
class ErrorHandler {
    ...
    static formatError(error, context = {}) {
        ...
        if (context.projectId) contextItems.push(`**Project ID:** ${context.projectId}`);
        if (context.environment) contextItems.push(`**Environment:** ${context.environment}`);
        if (context.deploymentId) contextItems.push(`**Deployment ID:** ${context.deploymentId}`);
