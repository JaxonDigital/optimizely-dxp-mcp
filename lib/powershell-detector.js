 ...
 * @param {boolean} forceNew - Force creation of a new instance (useful for retrying detection)
 */
function getPowerShellDetector(forceNew = false) {
    if (!detectorInstance || forceNew) {
