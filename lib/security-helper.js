...
class SecurityHelper {
     ...
     */
    static maskSecret(value, showChars = 4) {
     ...
     */
    static sanitizeObject(obj, additionalFields = []) {
    ...
    static validateCredentials(credentials) {
        ...
        } else if (!credentials.projectId.match(/^[a-f0-9-]+$/i)) {
            errors.push('Project ID has invalid format (should be UUID)');
        }
     ...
     */
    static createSafeLogContext(context) {
        const safe = {};
