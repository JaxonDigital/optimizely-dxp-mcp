...
class Telemetry {
    constructor() {
        ...
        this.enabled = process.env.OPTIMIZELY_MCP_TELEMETRY === 'true' || 
                      process.env.MCP_TELEMETRY === 'true';
        
        // Anonymous session ID
        this.sessionId = this.generateSessionId();
        
        // Telemetry endpoint (would be your analytics service)
        this.endpoint = process.env.TELEMETRY_ENDPOINT || null;
    ...
    queueEvent(event) {
        ...
        // Send immediately if online, otherwise store locally
        if (this.endpoint) {
