...
class DeploymentActionOperations {
    ...
    static async startDeployment(args) {
        ...
        const isUpward = DeploymentFormatters.isUpwardDeployment(sourceEnvironment, targetEnvironment);
        ...
        if (deploymentType) {
            ...
            if (deploymentType === 'code') {
                deployCode = true;
            } else if (deploymentType === 'content') {
                deployContent = true;
            } else if (deploymentType === 'all') {
                deployCode = true;
                deployContent = true;
            }
        } else {
        ...
        if (result.parsedData) {
            return DeploymentFormatters.formatDeploymentStarted(result.parsedData, args);
        }
