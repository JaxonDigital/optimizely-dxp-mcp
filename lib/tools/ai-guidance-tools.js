    ...
    static async getDatabaseExportWorkflow(args = {}) {
        try {
            ...
            try {
                ...
                const messages = DatabaseExportPrompts.getPromptMessages('database-export-workflow', promptArgs);
...
- **PREFERRED**: Use \`autoMonitor: false\` to disable behind-the-scenes monitoring - it's hard to debug
...
5. AI: "Starting fresh export..."
   → \`export_database({ forceNew: true, autoMonitor: false })\`  // Disable auto-monitoring!
