...
class LoggingTools {
    ...
    static async getEdgeLogs(args) {
        ...
        // Build command - Note: Get-EpiEdgeLogLocation doesn't have Environment parameter
        // It returns logs for the entire project
        let command = `Get-EpiEdgeLogLocation -ClientKey '${apiKey}' -ClientSecret '${apiSecret}' -ProjectId '${projectId}'`;
