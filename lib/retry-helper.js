...
class RetryHelper {
     ...
     * @param {Function} executeFn - The API operation function
     * @param {Object} context - Context for error messages
     * @param {Object} retryOptions - Retry configuration
     * @returns {Promise<*>} Result from API operation
     */
    static async retryOperation(executeFn, context = {}, retryOptions = {}) {
