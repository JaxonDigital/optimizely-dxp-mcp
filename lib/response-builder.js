...
class ResponseBuilder {
     ...
     * Returns both machine-readable data and human-readable message
     * @param {Object} data - Structured data for automation tools (n8n, Zapier, etc.)
     * @param {string} message - Human-readable message for AI assistants and users
     * @returns {Object} Response object with both data and message
     */
    static successWithStructuredData(data, message) {
     ...
     */
    static confirmationRequired(message) {
