...
class DeploymentWorkflowPrompts {
     ...
     */
    static getPromptMessages(promptName, args = {}) {
     ...
     */
    static getStartPrompt(sourceEnvironment, targetEnvironment) {
        return [
            {
                role: 'user',
                content: {
...
💡 **Note:** I'll use the proper MCP monitoring tools instead of bash loops - this is more efficient and provides better progress tracking.`
     ...
     */
    static getMonitoringPrompt(deploymentId, targetEnvironment) {
        return [
            {
                role: 'user',
                content: {
...
I'll keep you updated on the progress! 🚀`
     ...
     */
    static getVerificationPrompt(deploymentId, targetEnvironment) {
        return [
            {
                role: 'system',
                content: {
...
Have you had a chance to review the verification URLs? Let me know when you're ready to proceed!`
     ...
     */
    static getCompletedPrompt(deploymentId) {
        return [
            {
                role: 'user',
                content: {
...
Is there anything else you'd like me to help you with?`
     ...
     */
    static getErrorPrompt(deploymentId) {
        return [
            {
                role: 'system',
                content: {
...
module.exports = DeploymentWorkflowPrompts;