    ...
    constructor(options = {}) {
        this.options = {
            ...
            operationTtl: {
                ...
                get_deployment_status: 5 * 1000,        // 5 seconds (status changes frequently)
                list_storage_containers: 10 * 60 * 1000, // 10 minutes (containers rarely change)
                get_project_info: 15 * 60 * 1000,       // 15 minutes (project info rarely changes)
                export_database: 60 * 1000,             // 1 minute (export status changes)
                check_export_status: 15 * 1000,         // 15 seconds (export status changes rapidly)
