...
class DownloadManager extends EventEmitter {
     ...
     */
    generateDownloadKey(projectName, containerName, environment, dateRange = null) {
        const parts = [
            projectName || 'unknown',
     ...
     */
    setProgressMonitor(key, progressMonitor) {
        const download = this.activeDownloads.get(key);
        if (download) {
