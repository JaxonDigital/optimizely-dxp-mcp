...
test('Package.json Validation', () => {
    ...
    assert(pkg.main === 'jaxon-optimizely-dxp-mcp.js',
        `Package main mismatch: expected 'jaxon-optimizely-dxp-mcp.js' but got '${pkg.main}'`);
...
test('Main Server File', () => {
    const mainFile = path.join(__dirname, '..', 'jaxon-optimizely-dxp-mcp.js');
